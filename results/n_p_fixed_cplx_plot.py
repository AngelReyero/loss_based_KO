...
palette = {
    ...
    'dCRT': 'magenta',
    'HRT': 'gold',
    'CPI_KO_CPLX_ST': "green",
    'CPI_KO_CPLX_Wilcox': "green",
}
...
csv_files = glob.glob(f"csv/n_p_fixed_cplx_{y_method}_Var_cor{cor}*.csv")
...
plt.savefig(f"figures/n_p_fixed_cplx_{y_method}_p{p}_cor{cor}.pdf", bbox_inches="tight")
...
plt.savefig(f"figures/valid_n_p_fixed_cplx_{y_method}_p{p}_cor{cor}.pdf", bbox_inches="tight")
