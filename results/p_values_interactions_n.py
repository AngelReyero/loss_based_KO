...
settings = ["poly", "interact_sin", "interact_pairwise", "interact_oscillatory", "interact_latent" ,"cos"]
models = ['GB']
for setting in settings:
    for model in models:
        for n in ns:
            csv_files = glob.glob(f"res_csv/p_values_{setting}_{model}_n{n}_seed*.csv")
            ...
            plt.savefig(f"new_figures/p_values_{setting}_{model}_n{n}.pdf", bbox_inches="tight")
