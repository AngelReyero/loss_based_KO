...
# AUC
methods_to_plot = ['Sobol-CPI(1)', 'Sobol-CPI(10)', 'Sobol-CPI(100)', 'LOCO', 'LOCO-W', 'CPI_KO_ST'] 
...
plt.savefig(f"figures/CPI_KO_inference_hidimstats_p{p}_cor{cor}_auc.pdf", bbox_inches="tight")
...
plt.savefig(f"figures/CPI_KO_inference_hidimstats_p{p}_cor{cor}.pdf", bbox_inches="tight")
...
plt.savefig(f"figures/valid_CPI_KO_inference_hidimstats_p{p}_cor{cor}.pdf", bbox_inches="tight")
...
plt.savefig(f"figures/CPI_KO_inference_poly_p{p}_cor{cor}_time.pdf", bbox_inches="tight")
...
plt.savefig(f"figures/CPI_KO_valid_inference_poly_p{p}_cor{cor}.pdf", bbox_inches="tight")