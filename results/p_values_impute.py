...
for setting in settings:
    for model in models:
        for imputer in imputers:
            csv_files = glob.glob(f"res_csv/p_values_{setting}_{model}_imp{imputer}_seed*.csv")
            ...
            plt.savefig(f"new_figures/p_values_{setting}_{model}_imp{imputer}.pdf", bbox_inches="tight")
