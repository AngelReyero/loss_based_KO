...
def main(args):
    ...
    for s in args.seeds:
        ...
        p_val=np.zeros((29, len(ns), p))
        executation_time = np.zeros((29, len(ns)))
        ...
        for (i,n) in enumerate(ns):
            ...
            p_val[27,i, :p]= d0crt.pvalues_.reshape((p,))
            ...
            p_val[25,i, :p]= cpi_KO_importance["pval"].reshape((p,))
            ...
            p_val[26,i, :p]= cpi_KO_importance["pval"].reshape((p,))
            ...
            p_val[21,i, :p]= cpi_importance["pval"].reshape((p,))
            ...
            p_val[22,i, :p]= cpi_importance["pval"].reshape((p,))
            ...
            p_val[1,i, :p]= cpi_importance["pval"].reshape((p,))
            ...
            p_val[2,i, :p]= cpi_importance["pval"].reshape((p,))
            ...
            p_val[3,i, :p]= cpi_importance["pval"].reshape((p,))
            ...
            p_val[4,i, :p]= cpi_importance["pval"].reshape((p,))
            ...
            p_val[5,i, :p]= cpi_importance["pval"].reshape((p,))
            ...
            p_val[6,i, :p]= cpi_importance["pval"].reshape((p,))
            ...
            p_val[7,i, :p]= cpi_importance["pval"].reshape((p,))
            ...
            p_val[8,i, :p]= cpi_importance["pval"].reshape((p,))
            ...
            p_val[9,i, :p]= cpi_importance["pval"].reshape((p,))
            ...
            p_val[10,i, :p]= cpi_importance["pval"].reshape((p,))
            ...
            p_val[11,i, :p]= cpi_importance["pval"].reshape((p,))
            ...
            p_val[12,i, :p]= cpi_importance["pval"].reshape((p,))
            ...
            p_val[13,i, :p]= cpi_importance["pval"].reshape((p,))
            ...
            p_val[14,i, :p]= cpi_importance["pval"].reshape((p,))
            ...
            p_val[15,i, :p]= cpi_importance["pval"].reshape((p,))
            ...
            p_val[17,i, :p]= loco_importance["pval"].reshape((p,))
            ...
            p_val[18,i, :p]= loco_importance["pval"].reshape((p,))
            ...
            p_val[19,i, :p]= loco_importance["pval"].reshape((p,))
            ...
            p_val[20,i, :p]= loco_importance["pval"].reshape((p,))
    ...
    for i in range(29):
        for j in range(len(ns)):
            ...
            methods = [
                ...
                "CPI_KO_ST","CPI_KO_Wilcox", 'dCRT', 'HRT'
            ]
    ...
    csv_path = os.path.abspath(os.path.join(
        ...
        f"../../results/csv/n_p_all_{y_method}_Var_cor{cor}_seed{s}.csv"
    ))
